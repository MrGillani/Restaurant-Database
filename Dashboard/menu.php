...
<body>
    ...
    <div class="main-content">
        ...
        <div class="button-container">
            <button class="menu-btn" onclick="location.href='view_menu.php'">🍔 View Menu</button>
            <button class="menu-btn" onclick="location.href='add_item.php'">➕ Add New Item</button>
            <button class="menu-btn" onclick="location.href='edit_item.php'">🛠️ Edit Item</button>
            <button class="menu-btn" onclick="location.href='delete_item.php'">🗑️ Delete Item</button>
        </div>
    </div>
</body>
</html>
